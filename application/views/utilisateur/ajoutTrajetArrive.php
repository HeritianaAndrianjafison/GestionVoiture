<html lang="en">
  <head>
    ...
    <title>Ajout de trajet Arrive</title>
    <script>
    ...
    <div class="container" >
      <div class="row">
        <div id="block1" class="col-md-12">
          <h2 class="h2">Ajout De trajet Arrive</h2>
          <form action="<?= base_url() ?>ajoutTrajet/addArrive" method="post">
                  ...
                  foreach ($test->result() as $row)
                    {
                            echo 
                            '
                             <input type="hidden" name="idTrajet" value="'.$row->id.'">
                             <input type="hidden" name="idVoiture" value="'.$row->idVoiture.'">
                             <input type="hidden" name="dateDepart " value="'.$row->dateDepart.'">
                             <input type="hidden" name="kilometrageDepart  " value="'.$row->dateDepart.'">
                             <input type="hidden" name="heureDepart   " value="'.$row->heureDepart.'">
                            ';
                    }
             ?>             
              <?php 
